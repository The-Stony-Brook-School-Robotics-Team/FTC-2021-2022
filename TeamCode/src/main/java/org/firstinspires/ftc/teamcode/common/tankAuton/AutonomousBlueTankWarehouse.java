...
@Autonomous (name = "A - Auton (Blue Tank WAREHOUSE)")
public class AutonomousBlueTankWarehouse extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        distance = RoadRunnerController.distanceTwoPoints(driver.getPos(),finalPosition);
