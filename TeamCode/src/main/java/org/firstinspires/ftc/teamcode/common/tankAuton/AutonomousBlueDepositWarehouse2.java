...
import org.sbs.bears.robotframework.controllers.CapstoneOpenCVEngineBlueTank;
...
@Autonomous(name = "A - Auton (Blue Tank Deposit2 WAREHOUSE)")
public class AutonomousBlueDepositWarehouse2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // STEP 2: Park in Warehouse
        driver.goForwardGyro(24, 0.5,terminator,P,I,D);
