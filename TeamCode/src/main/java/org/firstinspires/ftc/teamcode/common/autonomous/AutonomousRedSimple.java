...
@Autonomous (name = "A - Auton (Red Duck Storage)")
public class AutonomousRedSimple extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        brain = new AutonomousBrainSimple(hardwareMap,telemetry,AutonomousMode.RedStatesDuckSimple);
        Log.d("Auton RS","Init Complete");
