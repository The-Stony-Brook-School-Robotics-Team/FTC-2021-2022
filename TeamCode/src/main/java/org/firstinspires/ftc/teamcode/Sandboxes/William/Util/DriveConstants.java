...
public class DriveConstants {
    ...
    private static final double TRACK_WIDTH = 12.75;        //Actual measurement: 12.00
    public static double WHEEL_RADIUS = 1;                  //Actual measurement: 1.
    ...
    public static double MAX_ANG_VEL = 24;      // measured with max ang velocity tuner.
