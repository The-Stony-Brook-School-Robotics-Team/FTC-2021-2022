...
public class AutonomousBrainTurn {
    ...
    RoadRunnerControllerTurn RRctrl;
    ...
    public AutonomousBrainTurn(HardwareMap hardwareMap, Telemetry telemetry, AutonomousMode mode) // call in init.
    {
        this.mode = mode;
        ...
        this.RRctrl = new RoadRunnerControllerTurn(hardwareMap,telemetry);
