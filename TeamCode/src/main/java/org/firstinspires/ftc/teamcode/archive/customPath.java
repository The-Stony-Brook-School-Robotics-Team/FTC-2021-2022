...
public class customPath extends ArrayList<Waypoint> {
     ...
     */
    public customPath(Waypoint... waypoints) {
    ...
    public boolean followPath(MecanumDrive mecanumDrive, OdometrySubsystem odometry) {
        ...
        while (!isFinished()) {
            ...
            DashboardUtil.drawRobot(ftcField, new com.coyote.framework.core.geometry.Pose2d(odometry.getPose().getX(), -(odometry.getPose().getY()), -(odometry.getPose().getHeading())));
     ...
     */
    public customPath setPathTimeout(long timeoutMiliseconds) {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath setPathType(PathType pathType) {
     ...
     */
    public customPath setMotionProfile(PathMotionProfile profile) {
        if (profile == null)
     ...
     * @return This path, used for chaining methods.
     */
    public customPath setWaypointTimeouts(long... timeouts) {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath setWaypointTimeouts(long timeout) {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath setRetraceSettings(double movementSpeed, double turnSpeed) {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath resetTimeouts() {
        timedOut = false;
        lastWaypointTimeStamp = System.currentTimeMillis();
        return this;
    }
     ...
     * @return This path, used for chaining methods.
     */
    public customPath enableRetrace() {
        retraceEnabled = true;
        return this;
    }
     ...
     * @return This path, used for chaining methods.
     */
    public customPath disableRetrace() {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath addTriggeredActions(TriggeredAction... actions) {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath removeTriggeredAction(TriggeredAction action) {
     ...
     * @return This path, used for chaining methods.
     */
    public customPath clearTriggeredActions() {
