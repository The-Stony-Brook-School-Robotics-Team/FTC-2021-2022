 ...
 */
@Config
public class DuckOpenCVEngineBlueFull extends DuckOpenCVEngine {
    // MARK - Class Variables

    public DuckOpenCVEngineBlueFull() {
        super();
     ...
     */
    public static int XOffsetA = -345; // -500
    /**
     ...
     */
    public static int XOffsetC = 680;
    /**
