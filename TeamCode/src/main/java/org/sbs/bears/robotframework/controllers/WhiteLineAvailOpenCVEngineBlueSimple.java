 ...
 */
@Config
public class WhiteLineAvailOpenCVEngineBlueSimple extends DuckOpenCVEngine {
    // MARK - Class Variables

    public WhiteLineAvailOpenCVEngineBlueSimple() {
        super();
     ...
     */
    public static int XOffsetA = -520; // -500
    /**
